    ...
    <div className="min-h-screen px-4 py-8 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-3xl rounded-[2rem] border border-[color:var(--border)] bg-[color:var(--surface)] p-6 shadow-[0_24px_80px_rgba(24,35,15,0.08)] backdrop-blur lg:p-8">
        <div className="flex items-center justify-between gap-4">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-[color:var(--accent)]">NGO profile</p>
            <h1 className="mt-2 text-3xl font-semibold text-[color:var(--foreground)]">Complete your profile details</h1>
          </div>
          <Link href="/dashboard/ngo" className="rounded-full border border-[color:var(--border)] bg-white/70 px-4 py-2 text-sm font-semibold transition hover:bg-white">
            Back to dashboard
          </Link>
        </div>
